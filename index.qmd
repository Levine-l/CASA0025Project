...
$$
d_{\text{confirmed}}(i)=\min_{c \in C}\text{dist}(i,c)
$$

$$
d_{\text{border}}(i)=\text{dist}(i,B)
$$
...
where \(Z_i\) is the 500 m candidate zone, \(C\) is the set of confirmed sites, and \(B\) is the national border.
