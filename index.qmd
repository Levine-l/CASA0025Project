...
VIIRS nighttime light change, distance variables and candidate-zone area. 
...
where \(Z_i\) is the 500 m candidate zone, \(C\) is the set of confirmed sites, and \(D_B\) is the raster distance surface generated from national borders.
...
Stage 2 uses 500 m candidate zones to build candidate-level metrics. Sentinel-2 and VIIRS composites produce NDVI/NDBI and night-time light change indicators.
